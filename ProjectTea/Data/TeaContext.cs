...
public partial class TeaContext : DbContext
{
    ...
    public virtual DbSet<HangHoaLog> HangHoaLogs { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=WINDOWS-11\\SQLEXPRESS;Initial Catalog=Tea;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HangHoa>(entity =>
        {
            ...
            entity.ToTable("HangHoa", tb =>
                {
                    tb.HasTrigger("trg_AfterDeleteHangHoa");
                    tb.HasTrigger("trg_AfterInsertHangHoa");
                    tb.HasTrigger("trg_AfterUpdateHangHoa");
                });
